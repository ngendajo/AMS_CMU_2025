...
const AddressMoreInfo = ({ setForm, formData, navigation }) => {
  ...
  const [selectedDistrict, setSelectedDistrict] = useState("");
    ...
    return (
        <div className="form">
          <h3>Address More Info</h3>
          
          <center>
            <label htmlFor="marital_status">Marital Status</label>
            <select name="marital_status" value={marital_status} onChange={setForm}>
          ...
          {currresidence_in_rwanda=="Yes"?
            <>
              <center>
                ...
                <select id="districtSelect" name="currresidence_district_or_country" value={selectedDistrict}  onChange={handleDistrictChange}>
              ...
              {selectedDistrict && (
                <center>
                  ...
                  <select id="sectorSelect" name="currresidence_sector_or_city" value={selectedSector} onChange={setForm}>
            ...
            <>
              <ItemForm label="Country" name="currresidence_district_or_country" value={currresidence_district_or_country} onChange={setForm} />
              <ItemForm label="City" name="currresidence_sector_or_city" value={currresidence_sector_or_city} onChange={setForm} />
            </>
          }
