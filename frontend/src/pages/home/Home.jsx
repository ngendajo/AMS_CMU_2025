...
export default function Home() {
    ...
    const [showPopup, setShowPopup] = useState(false); // Control visibility of the login pop-up
    const [welcomeMsg, setWelcomeMsg] = useState(''); // Control welcome message after login
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setPwd('');
            setShowPopup(false);
            setWelcomeMsg(`Welcome, ${user.name || 'User'}!`);
            setTimeout(() => {
                setWelcomeMsg('');
    ...
    return (
        <div>
            <HomeHeader onLoginClick={handleLoginClick} />
            <HomeFooter />
            {showPopup && (
            ...
            <p className="welcome-msg">{welcomeMsg}</p> {/* Display welcome message */}
