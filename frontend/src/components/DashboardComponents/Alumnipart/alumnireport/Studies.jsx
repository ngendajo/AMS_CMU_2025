        ...
        try{
            ...
            response.data.forEach(element => {
              alumnilist.push({
                ...
                degree:element.level==="PHD"? "PHD":element.level==="M"? "Masters":element.level==="A0"? "Bachelors":element.level==="A1"? "Diploma":element.level==="C"? "Certificate":element.level==="NMS"? "No further studies":element.level==="N"? "No Info":null,
              ...
              alumnilist2.push({
                ...
                name:element.first_name+" "+element.last_name,
                phone:element.phone1,
                level:element.level==="PHD"? "PHD":element.level==="M"? "Masters":element.level==="A0"? "Bachelors":element.level==="A1"? "Diploma":element.level==="C"? "Certificate":element.level==="NMS"? "No further studies":element.level==="N"? "No Info":null,
