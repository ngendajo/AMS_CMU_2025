...
const ProfileCard = () => {
  ...
  const commonIndustry = 
    ["Advertising", "Aerospace", "Agriculture", "Arts & Culture", "Automotive",
      "Banking", "Biotechnology", "Chemicals", "Construction", "Consulting",
      "Consumer Goods", "Defense", "Education", "Energy", "Entertainment",
      "Environmental Services", "Fashion", "Finance", "Food & Beverage",
      "Government", "Healthcare", "Hospitality", "Human Resources",
      "Information Technology", "Insurance", "Legal Services", "Manufacturing",
      "Marketing", "Media", "Mining", "Non-Profit", "Pharmaceuticals",
      "Professional Services", "Public Relations", "Real Estate", "Retail",
      "Sports", "Supply Chain Management", "Telecommunications",
      "Transportation & Logistics", "Travel & Tourism", "Utilities", "Wholesale"]
  ...
  const handleRequestAcademic = () => {
    ...
    if (validateNewStudy()) {
      ...
      axios.post(baseUrl+'/studie/', {
        "alumn": alumn_id,
        "level": newStudy.level,
        "degree": newStudy.degree,
        "university": newStudy.university,
        "country": newStudy.country,
        "city": newStudy.city,
        "scholarship": newStudy.scholarship,
        "scholarship_details": newStudy.scholarship_details,
          ...
          <>
            <div className="vertical-table">
              <table className="fixed-table">
                ...
                <thead>
                  <tr>
                    <th>Father&rsquo;s Name</th>
                  </tr>
                </thead>
                <tbody>
                {user.map((use, i) => (
                  <tr>
                    <td>{use.alumn.father}</td>
                  </tr>
                ))}
                </tbody>
                <thead>
                  <tr>
                    <th>Mother&rsquo;s Name</th>
                  </tr>
                </thead>
                <tbody>
                {user.map((use, i) => (
                  <tr>
                    <td>{use.alumn.mother}</td>
                  </tr>
                ))}
                </tbody>
              </table>
              ...
              <table className="fixed-table">
                ...
                {user.map((use, i) => (
                  <tr>
                    <td>{use.alumn.family.grade.grade_name}</td>
                  </tr>
                  ))}
                </tbody>
                <thead>
                ...
                {user.map((use, i) => (
                  <tr>
                    <td>{`${use.alumn.family.family_name}
              ...
              <table className={`fixed-table ${editMode ? 'edit-mode' : 'last'}`}>
                <thead className="first-row">
                  <tr>
                    ...
                    <tr>
                      <td>
                        <select value={children ? "true" : "false"} onChange={handleChildrenChange}>
                          ...
                          <option value="false">No Child</option>
                        </select>
                      </td>
                    </tr>
                ) : (
                    <tr>
                      <td>{children ? "Yes" : "No Child"}</td>
                    </tr>
                  )}
                </tbody>
              </table>
