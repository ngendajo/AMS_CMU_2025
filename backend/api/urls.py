...
urlpatterns = [
    ...
    path('students-per-grade/', views.StudentsPerGradeView.as_view(), name='students_per_grade'),# from retrieving student per grade per gender
    ...
    #
    path('alumnidata/', views.AlumniListView.as_view(), name='alumni-list'),
