...
class Alumni(models.Model):
    ...
    alumni_nid = models.CharField(max_length=200,default="")
    ...
    guardian_names = models.CharField(max_length=500,default="")
    guardian_mobile = models.CharField(max_length=500,default="")
    guardian_mobile_number = models.CharField(max_length=500,default="")
    guardian_id = models.CharField(max_length=500,default="")
    ...
    currresidence_cell = models.CharField(max_length=500,default="")
    resident_village = models.CharField(max_length=500,default="")
